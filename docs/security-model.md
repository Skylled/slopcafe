...
Defined in [`../src/serve-policy.ts`](../src/serve-policy.ts) and enforced by [`../src/serve.ts`](../src/serve.ts). A document is served across
**two URLs on purpose**:
...
enforced on the HTML byte path in [`../src/serve.ts`](../src/serve.ts) (`/raw`) and [`../src/serve-shell.ts`](../src/serve-shell.ts) (the shells).
...
[`../src/audit.ts`](../src/audit.ts) + migration `0020_audit_events.sql`
