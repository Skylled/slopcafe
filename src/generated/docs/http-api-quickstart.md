...
[`http-api.md`](/docs/http-api) or the machine-readable
...
[`http-api.md`](/docs/http-api). Its `info.version` is the contract version under
**strict semver** (currently `3.0.1`). The `3.0` breaking-change window closed
on 2026-09-05, so `^3.0.0` is a safe pin and any future break lands as `4.0.0`.
...
[`../skills/publishing.md`](/docs/publishing-guide).

## See also

- [`http-api.md`](/docs/http-api) — the full HTTP/REST reference.
- [`../skills/publishing.md`](/docs/publishing-guide) — the authoring contract
  (what survives sanitization).
- [`security-model.md`](/docs/security-model) — how hostile HTML is served safely.
