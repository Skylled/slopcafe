...
This note follows the shape of [`vector-search-design.md`](/docs/vector-search-design): problem → decisions →
...
planned next layer" already named in [`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo) §5.
...
[`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo) §4 already describes for `public_id`/`slug`.
...
subdomains ([`agent-knowledge-host-spec-PLATFORM-v2.md`](/docs/spec-platform) §7.1) — a single flat
