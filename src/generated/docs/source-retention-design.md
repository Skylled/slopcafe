...
This note follows the shape of [`byte-exact-publish-design.md`](/docs/byte-exact-publish-design): problem → root
...
- **Markdown docs** (`source_format = "markdown"`): **do NOT** copy the
  ...
  - **Preferred:** re-publish from the *true* repo source. Several live docs are
    ...
    [`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo) and
    [`agent-knowledge-host-spec-PLATFORM-v2.md`](/docs/spec-platform).
...
- **[`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo) §5**: promote convert-and-discard
...
- **[`agent-knowledge-host-spec-PLATFORM-v2.md`](/docs/spec-platform)**: lineage note only if the SOLO
