...
This follows the shape of [`source-retention-design.md`](/docs/source-retention-design) /
[`byte-exact-publish-design.md`](/docs/byte-exact-publish-design): problem → decisions → mechanics → docs/test/cost
→ rollout → deferred.
...
[`source-retention-design.md`](/docs/source-retention-design) §8), and re-issuing a
...
3. **[`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo)** — search gains a semantic axis; move
...
[`byte-exact-publish-design.md`](/docs/byte-exact-publish-design)-style note: not bundled, reference-only.
