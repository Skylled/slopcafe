...
shared write path** ([`../src/core.ts`](https://github.com/Skylled/slopcafe/blob/main/src/core.ts)), so both the HTTP and
...
bounds live in the shared write path ([`../src/core.ts`](https://github.com/Skylled/slopcafe/blob/main/src/core.ts)), so
