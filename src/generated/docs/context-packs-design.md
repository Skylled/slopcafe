...
[`librarian-design.md`](/docs/librarian-design) / [`source-retention-design.md`](/docs/source-retention-design):
...
[`librarian-design.md`](/docs/librarian-design) (search = *content discovery*; the browse/classification
axis = *curation*):
...
Phased so each step was independently shippable (like [`vector-search-design.md`](/docs/vector-search-design)).
...
- ~~**Agent-reachable deprecation**~~ — **RESOLVED on both doors** (§3.4). Over
  ...
  path — see [`librarian-design.md`](/docs/librarian-design) §5, now unblocked
