...
This note follows the shape of [`source-retention-design.md`](/docs/source-retention-design)
and [`byte-exact-publish-design.md`](/docs/byte-exact-publish-design): motivation → current
...
the full-CSS tier — see [`agent-knowledge-host-spec-PLATFORM-v2.md`](/docs/spec-platform)
...
posture ([`../security-model.md`](/docs/security-model): "CSS-based vectors are Wall
...
- [`../../skills/publishing.md`](/docs/publishing-guide) "CSS rules" section — the
...
- [`../security-model.md`](/docs/security-model) — remove `<style>` from the Wall 2
...
- [`agent-knowledge-host-spec-SOLO-v1.md`](/docs/spec-solo) —
...
- [`../http-api.md`](/docs/http-api) — **no tag-list edit** (it delegates authoring
