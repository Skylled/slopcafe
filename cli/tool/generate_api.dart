...
// flow (see ../README.md "Development") is:
//
//   dart run tool/generate_api.dart
//   dart run build_runner build
//
// NOTE: `--delete-conflicting-outputs` was REMOVED from build_runner and is now
// ignored with a warning — do not re-add it to these instructions.
//
...
class _Generator {
  ...
  String _banner() =>
      ...
      '// after re-pinning the spec. See cli/README.md "Development".\n';
